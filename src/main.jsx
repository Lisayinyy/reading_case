  ...
  useEffect(() => {
    ...
    const animate = (now) => {
      ...
      if (target) {
        ...
        stage.style.setProperty('--lamp-x', `${motion.anchorX}px`)
        stage.style.setProperty('--cone-x', `${motion.anchorX - coneHalfWidth}px`)
        stage.style.setProperty('--lamp-tilt', `${motion.swingZ}deg`)
        stage.style.setProperty('--lamp-pitch', `${motion.swingX}deg`)
        stage.style.setProperty('--cone-offset-x', `${motion.coneOffsetX}px`)
        stage.style.setProperty('--cone-y', `${motion.coneOffsetY}px`)
