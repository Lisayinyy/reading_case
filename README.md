...
The interface uses no experimental browser APIs and works without WebGL. The smoke-like atmosphere is a lightweight `<canvas>` enhancement; the paper remains usable when animation is reduced.
